...
void HistogramTreeWidget::editDataFilter(QTreeWidgetItem *node)
{
    ...
    if (dialog.exec() == QDialog::Accepted)
    {
        // TODO: update 2d histograms referencing any of the histograms that
        // where created by this filter. 2d histograms referencing addresses
        // that are not in the filter range anymore should be removed
#if 0
        ...
        {
            for each histo:
                update histoconfig and histo properties
        }
#endif
