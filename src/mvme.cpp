    ...
    //
    {
        ...
        // Make a chain
        {
            ...
            for (int i=0; i<20; ++i)
            {
                ...
                analysis_ng->m_operators.push_back({0, nextSelector});
...

        {
            ...
            analysis_ng->m_operators.push_back({0, sink});
        }
#endif
    }
}
